...
We recruited a group of 10 participants (6 Females) to participate in our data collection process. Additionally, 5 of the participants wore glasses, and 2 participants were native English speakers without any discernible accents. Sequentially in the data collection, we placed our depth sensing device at three distinct sensor locations (Figure 2):
...
- In Environement: In this setup, we placed the iPhone on a table with a randomized tilt angle and distance, simulating the positioning of depth sensors that could be potentially integrated onto smart devices such as Google Nest.

You can find the sentence dataset from here: [Sentence Dataset](https://your-url.example.com).

## System Evaluation
<Figure>
  <Image slot="figure" source={association} altText="" />
  <span slot="caption" class="block text-left">
  Figure 2: Three sensor locations in the user: On-Wrist (left), On-Head (middle), and In-Environment (right).
  </span>
</Figure>
