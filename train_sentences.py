...
def parse_args():
    ...
    parser.add_argument('--data-path', default='../WatchYourMouth2.0/UserStudy2.0/', type=str, help='dataset')
    parser.add_argument('--train-dataset', default='Sentences/TrainTest_Cross/Train_cross2.txt', type=str, help='train dataset')
    parser.add_argument('--test-dataset', default='Sentences/TrainTest_Cross/Test_cross2.txt', type=str, help='test dataset')
    parser.add_argument('--seed', default=0, type=int, help='random seed')
    parser.add_argument('--model', default='PSTTransformer', type=str, help='model')
    parser.add_argument('--save-model', default='./Log/checkpoints/', type=str, help='model save path')
    parser.add_argument('--save-loss', default='./Log/checkpoints/loss.txt', type=str, help='loss save file')
    parser.add_argument('--save-performance', default='./Log/checkpoints/best_performance.json', type=str, help='performance save file')
    # input
    ...
    # P4D
    parser.add_argument('--in-planes', default=3, type=float, help='input feature channels')
    parser.add_argument('--radius', default=0.05, type=float, help='radius for the ball query')
    ...
    parser.add_argument('--heads', default=3, type=int, help='transformer head')
    ...
    parser.add_argument('--dropout1', default=0.5, type=float, help='transformer dropout')
    # output
